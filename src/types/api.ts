...
export type LoginDevice = { device_id: string; device_name: string; device_model: string }
...
export interface Operations {
  ...
  zzzExplorationDetail: { params: Record<string, never>; data: Record<string, JsonValue> }
  buddy: { params: Record<string, never>; data: Record<string, JsonValue> }
}
